...
public class ListviewCoupon extends LinearLayout {

    ListviewCoupon.ListviewCouponOperationCallBack ListviewCouponOperationCallBack;


    public ListviewCoupon(Context context) {
        super(context);
    }

    public ListviewCoupon(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ListviewCoupon(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setData(final Context context, final List<CouponGetModel> data, final LoadImageCallBack loadImageCallBack) {
        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            final SSS_Adapter sss_adapter = new SSS_Adapter<CouponGetModel_List>(context, R.layout.item_fragment_coupon, data.get(finalI).list) {
                @Override
...
//                                }
            ...
            click_listview_coupon.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (ListviewCouponOperationCallBack != null) {
//                        ListviewCouponOperationCallBack.onClickTitle_ListviewCouponOperationCallBack(data.get(finalI).classify_id, data.get(finalI).name);
            ...
            more_listview_coupon.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (ListviewCouponOperationCallBack != null) {
    ...
    public void setListviewCouponOperationCallBack(ListviewCoupon.ListviewCouponOperationCallBack ListviewCouponOperationCallBack) {
        this.ListviewCouponOperationCallBack = ListviewCouponOperationCallBack;
    }


    public interface ListviewCouponOperationCallBack {

...
public class FragmentSaleAndSeckillDiscountsDiscounts extends BaseFragment implements RefreshLoadMoreLayout.CallBack {
    @BindView(R.id.listview_fragment_sale_and_seckill_discounts_discounts)
    InnerListview listviewFragmentSaleAndSeckillDiscountsDiscounts;
    @BindView(R.id.refresh_fragment_sale_and_seckill_discounts_discounts)
    RefreshLoadMoreLayout refreshFragmentSaleAndSeckillDiscountsDiscounts;
    @BindView(R.id.top_fragment_sale_and_seckill_discounts_discounts)
    ImageView topFragmentSaleAndSeckillDiscountsDiscounts;
    @BindView(R.id.scollview_fragment_sale_and_seckill_discounts_discounts)
    ScrollView scollviewFragmentSaleAndSeckillDiscountsDiscounts;
    @BindView(R.id.fragment_sale_and_seckill_discounts_discounts)
    LinearLayout FragmentSaleAndSeckillDiscountsDiscounts;
    Unbinder unbinder;
    int p = 1;
    String classify_id;
    String type;

    public FragmentSaleAndSeckillDiscountsDiscounts() {
    }

    List<SaleAndSeckillDiscountsCouponModel> saleAndSeckillDiscountsCouponModelList = new ArrayList<>();
    SSS_Adapter sss_adapter;

    public FragmentSaleAndSeckillDiscountsDiscounts(String classify_id,String type) {
    ...
    public void onDestroy() {
        ...
        sss_adapter = null;
        scollviewFragmentSaleAndSeckillDiscountsDiscounts = null;
        listviewFragmentSaleAndSeckillDiscountsDiscounts = null;
        refreshFragmentSaleAndSeckillDiscountsDiscounts = null;
        topFragmentSaleAndSeckillDiscountsDiscounts = null;
    ...
    protected int setContentView() {
        return R.layout.fragment_sale_and_seckill_discounts_discounts;
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
                                scollviewFragmentSaleAndSeckillDiscountsDiscounts.setOnScrollChangeListener(new View.OnScrollChangeListener() {
                                    @Override
                                    public void onScrollChange(View v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
                                        if (scrollY > Config.scoll_HighRestriction) {
                                            topFragmentSaleAndSeckillDiscountsDiscounts.setVisibility(View.VISIBLE);
                                        } else {
                                            topFragmentSaleAndSeckillDiscountsDiscounts.setVisibility(View.GONE);
                                        }
                                    }
                                });
                            }
                            topFragmentSaleAndSeckillDiscountsDiscounts.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    scollviewFragmentSaleAndSeckillDiscountsDiscounts.smoothScrollTo(0,0);
                                }
                            });
                            refreshFragmentSaleAndSeckillDiscountsDiscounts.init(new RefreshLoadMoreLayout.Config(FragmentSaleAndSeckillDiscountsDiscounts.this).canLoadMore(true).canRefresh(true));
                            initAdapter();
                            get_coupon();
                        }
                    });
    ...
    void initAdapter() {
        sss_adapter = new SSS_Adapter<SaleAndSeckillDiscountsCouponModel>(getBaseFragmentActivityContext(), R.layout.item_sale_and_seckill_discounts) {
            ...
            protected void setView(SSS_HolderHelper helper, int position, SaleAndSeckillDiscountsCouponModel bean,SSS_Adapter instance) {
                ...
                helper.setText(R.id.type_item_sale_and_seckill_discounts, "折扣券");
            }
        ...
        listviewFragmentSaleAndSeckillDiscountsDiscounts.setAdapter(sss_adapter);
    }
        ...
        try {
            addRequestCall(new RequestModel(System.currentTimeMillis() + "", RequestWeb.get_coupon(
                    new JSONObject()
                            ...
                            .put("p", p)
                            .put("type", "3")// 1满减券，2现金券，3折扣券
                            .toString(), new StringCallback() {
                        @Override
                        public void onError(Call call, Exception e, int id) {
                            if (refreshFragmentSaleAndSeckillDiscountsDiscounts != null) {
                                refreshFragmentSaleAndSeckillDiscountsDiscounts.stopRefresh();
                                refreshFragmentSaleAndSeckillDiscountsDiscounts.stopLoadMore();
                            }

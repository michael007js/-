...
public class FragmentSaleAndSeckillDiscountsFullCut extends BaseFragment implements RefreshLoadMoreLayout.CallBack {
    ...
    public FragmentSaleAndSeckillDiscountsFullCut() {
    }

    List<SaleAndSeckillDiscountsCouponModel> saleAndSeckillDiscountsCouponModelList = new ArrayList<>();
    SSS_Adapter sss_adapter;

    public FragmentSaleAndSeckillDiscountsFullCut(String classify_id,String type) {
                ...
                public void run() {
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            refreshFragmentSaleAndSeckillDiscountsDiscounts.init(new RefreshLoadMoreLayout.Config(FragmentSaleAndSeckillDiscountsFullCut.this).canLoadMore(true).canRefresh(true));
                            initAdapter();
                            get_coupon();
                        }
                    });
    ...
    void initAdapter() {
        sss_adapter = new SSS_Adapter<SaleAndSeckillDiscountsCouponModel>(getBaseFragmentActivityContext(), R.layout.item_sale_and_seckill_discounts) {
            ...
            protected void setView(SSS_HolderHelper helper, int position, SaleAndSeckillDiscountsCouponModel bean,SSS_Adapter instance) {
                ...
                helper.setText(R.id.type_item_sale_and_seckill_discounts, "满减券");
            }

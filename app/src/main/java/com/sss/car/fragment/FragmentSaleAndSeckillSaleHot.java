...
public class FragmentSaleAndSeckillSaleHot extends BaseFragment {
    @BindView(R.id.listViewSale_fragment_sale_and_seckill_sale_hot)
    LinearLayout listViewSaleFragmentSaleAndSeckillSaleHot;
    Unbinder unbinder;
    ...
    String activity = "1";/*（热门榜单activity= 1）（进行中activity= 2）（即将开场activity= 3）*/

    public FragmentSaleAndSeckillSaleHot(String classify_id, String type) {
        this.type = type;
        this.classify_id = classify_id;
    }

    public FragmentSaleAndSeckillSaleHot() {
    }

    @Override
    protected int setContentView() {
        return R.layout.fragment_sale_and_seckill_sale_hot;
    }
    ...
    public void onDestroy() {
        ...
        listViewSaleFragmentSaleAndSeckillSaleHot = null;
        classify_id = null;
        super.onDestroy();
    }
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            listViewSale.create(list.get(i).name, list.get(i).classify_id, new SSS_Adapter<GoodsModel>(getBaseFragmentActivityContext(), R.layout.item_sale_and_seckill_adapter) {
                ...
                protected void setItemListener(SSS_HolderHelper helper) {
                    ...
                    helper.setItemChildClickListener(R.id.click_item_sale_and_seckill_adapter);
                ...
                public void onItemChildClick(View view, int position, SSS_HolderHelper holder) {
                    switch (view.getId()) {
                        case R.id.get_item_sale_and_seckill_adapter:
                            ...
                            break;
                        case R.id.click_item_sale_and_seckill_adapter:
                            if (getBaseFragmentActivityContext() != null) {
                                startActivity(new Intent(getBaseFragmentActivityContext(), ActivityGoodsServiceDetails.class)
                                        .putExtra("type", type)
                                        .putExtra("goods_id", list.get(finalI).list.get(position).goods_id)
            ...
            listViewSaleFragmentSaleAndSeckillSaleHot.addView(listViewSale);

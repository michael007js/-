...
public class OrderGoodsReadyBuyList extends BaseActivity {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.back_top:
                finish();
                break;
            case R.id.click_yes_order_goods_ready_buy_list:
                ...
                if (!StringUtils.isEmpty(orderSellerModel.damages)) {
                    if (CarUtils.isDeposit(orderSellerModel.damages) == 0) {
                        ...
                        try {
                            ...
                            PayUtils.requestPayment(ywLoadingDialog,false, "0", orderSellerModel.order_id, 2, 1, String.valueOf(price), getBaseActivity(),null,"0");
                ...
                break;
            case R.id.click_no_order_goods_ready_buy_list:
                operation(12);
                break;
        }
    }
    ...
    void showData() {
        ...
        carNameOrderServiceReadyBuy.setText(orderSellerModel.address);

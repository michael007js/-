        ...
        if ("details".equals(getIntent().getExtras().getString("mode"))) {
            ...
            buyActivityCoupon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    PayUtils.requestPayment(ywLoadingDialog,"0", getIntent().getExtras().getString("coupon_id"), 3, 0, PriceUtils.formatBy2Scale(Double.valueOf(price_activity_coupon_head.getText().toString().trim()), 2), getBaseActivity());
                }
            });
            ...
            buyActivityCoupon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    PayUtils.requestPayment(ywLoadingDialog,"0", getIntent().getExtras().getString("coupon_id"), 3, 0, PriceUtils.formatBy2Scale(b, 2), getBaseActivity());
                }
            });
        }
    }

...
public class ActivityOrderSOSUnfinishDetails extends BaseActivity {
    ...
    protected void onDestroy() {
        ...
        menuDialog = null;
        backTop = null;
        titleTop = null;rightButtonTop=null;
        ...
        click_cancel_activity_order_sos_unfinish_details = null;
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.back_top:
                finish();
                break;
            case R.id.click_cancel_activity_order_sos_unfinish_details:
                cancel_sos();
                break;
                    ...
                    , new StringCallback() {
                        ...
                        public void onResponse(String response, int id) {
                            ...
                            try {
                                JSONObject jsonObject = new JSONObject(response);
                                if ("1".equals(jsonObject.getString("status"))) {
                                    EventBus.getDefault().post(new ChangedSOSList(getIntent().getExtras().getString("sos_id")));
                                    finish();
                                } else {
                                    ToastUtils.showShortToast(getBaseActivityContext(), jsonObject.getString("message"));
                                }

package com.blankj.utilcode.PullToRefreshRecyleView;
...
import com.blankj.utilcode.PullToRefreshRecyleView.callback.PullToRefreshListener;
...
public class PullToRefreshRecyclerView extends RecyclerView {
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        ...
        if (refreshHeader != null) {
            refreshHeader.setWidth(widthSpec);
        }
...
//    }
    ...
    public void addHeaderView(View view) {
        ...
        headViews.add(view);
        view.setLayoutParams(new LinearLayout.LayoutParams(headWidth, ViewGroup.LayoutParams.WRAP_CONTENT));
    ...
    public void addFooterView(View view) {
        ...
        view.setLayoutParams(new LinearLayout.LayoutParams(footerWidth, ViewGroup.LayoutParams.WRAP_CONTENT));
        dataObserver.onChanged();
        if (pullToRefreshRecyclerViewAdapter != null) {
            pullToRefreshRecyclerViewAdapter.adapter.notifyDataSetChanged();
        }
    ...
    public void onScrollStateChanged(int state) {
        ...
        if (state == RecyclerView.SCROLL_STATE_IDLE && pullToRefreshListener != null
                && loadingMoreEnabled && loadMoreView.getVisibility() != VISIBLE) {

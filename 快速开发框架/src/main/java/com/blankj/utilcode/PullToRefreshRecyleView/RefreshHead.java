...
//    private ImageView imageRefreshing;
    ...
    private boolean showLastRefreshTime=true;
//    private ValueAnimator animator;
    ...
    public RefreshHead(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        refreshLimitHeight = getScreenHeight() / 10;

        refreshContentView = LayoutInflater.from(getContext()).inflate(R.layout.layout_refresh_head_view, null);
...
//        imageArrow = (ImageView) refreshContentView.findViewById(imageArrow);
//        imageArrow.setVisibility(VISIBLE);
//        imageRefreshing = (ImageView) refreshContentView.findViewById(imageRefreshing);
        //一开始设置高度为0 不显示刷新布局

 ...
 */
@TargetApi(12)
public  class SSS_RVFragmentAdapter extends RecyclerView.Adapter<SSS_RVFragmentAdapter.FragmentViewHolder> {
    ...
    public SSS_RVFragmentAdapter(FragmentManager fm, RecyclerView mRecyclerView, List<Fragment> mList) {
        mFragmentManager = fm;
    ...
    public SSS_RVFragmentAdapter(FragmentManager fm, RecyclerView mRecyclerView) {
        mFragmentManager = fm;
        this.mRecyclerView = mRecyclerView;
        mList = new ArrayList<>();
    }

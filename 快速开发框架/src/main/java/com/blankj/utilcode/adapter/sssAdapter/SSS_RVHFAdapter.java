 ...
 */
public abstract class SSS_RVHFAdapter<C, G, H, F> extends RecyclerView.Adapter<SSS_RViewHolder> {
    ...
    public SSS_RVHFAdapter(RecyclerView mRecyclerView) {
        super();
    ...
    public SSS_RVHFAdapter(RecyclerView mRecyclerView,
                           int itemChildLayoutId, int itemGroupLayoutId, int itemHeaderLayoutId, int itemFooterLayoutId) {
        this(mRecyclerView);
    ...
    protected SSS_RViewHolder onCreateGroupViewHolder(ViewGroup parent, int viewType) {

        View itemView = LayoutInflater.from(mContext).inflate(itemGroupLayoutId, parent, false);

        return new SSS_RViewHolder(mRecyclerView, itemView).setViewType(viewType);
    ...
    protected SSS_RViewHolder onCreateHeaderViewHolder(ViewGroup parent, int viewType) {
    ...
    protected SSS_RViewHolder onCreateFooterViewHolder(ViewGroup parent, int viewType) {
   ...
   SSS_HolderHelper mHolderHelper = viewHolder.getSSS_HolderHelper();
    ...
    protected abstract void setHeaderView(SSS_HolderHelper helper, int position, H bean);

    protected abstract void setFooterView(SSS_HolderHelper helper, int position, F bean);


    @Override
    public  void onViewRecycled(SSS_RViewHolder holder) {
    ...
    protected void onHeaderViewRecycled(SSS_RViewHolder holder) {
    }


    protected void onFooterViewRecycled(SSS_RViewHolder holder) {
    }

    protected void onChildViewRecycled(SSS_RViewHolder holder) {
    }


    protected void onGroupViewRecycled(SSS_RViewHolder holder) {
    }

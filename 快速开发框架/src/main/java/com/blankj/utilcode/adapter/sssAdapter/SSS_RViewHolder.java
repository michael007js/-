...
public class SSS_RViewHolder extends RecyclerView.ViewHolder  {
    ...
    public SSS_RViewHolder(RecyclerView recyclerView, View itemView) {
        this(recyclerView,itemView,0);
    }


    public SSS_RViewHolder(RecyclerView recyclerView, View itemView, int ratio) {
        super(itemView);
        ...
        this.mHolderHelper = SSS_HolderHelper.holderHelperByRecyclerView(itemView);
    ...
    public SSS_RViewHolder setViewType(int viewType) {

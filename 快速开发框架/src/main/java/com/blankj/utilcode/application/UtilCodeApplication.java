...
import com.blankj.utilcode.Glid.GlideImageLoader;
 ...
 *
 * @B@@@B@M@B@L:7PGBOO8MOMOEP0Xri@B@Mk7,... B@B@BBMBB@B@0::rJP8MO0uvvu7..,B@B@B@B@Z7
...
public class UtilCodeApplication extends /*MultiDexApplication*/LitePalApplication {
     ...
     */
    public void initNetWorkStatusListener(boolean isPing, NetEventCallBack netEvevt) {
        this.isPing = isPing;
     ...
     * @param netEvevt
     */
    public void initNetWorkPing(boolean isPing, NetEventCallBack netEvevt) {
        this.isPing = isPing;
...
//        });
    ...
    /**
     *  初始化拍照与相册配置器(如果需要使用，则必须初始化fresco)
     */
...
//            imageloader = new GlideImageLoader();
     ...
     * <p>
     * 记得在manifest中注册
     * <receiver android:name="com.blankj.utilcode.application.UtilCodeApplication$NetStatusBroadcastReceiver" >
     * <intent-filter>

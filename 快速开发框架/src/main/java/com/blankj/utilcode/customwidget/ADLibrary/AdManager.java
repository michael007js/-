package com.blankj.utilcode.customwidget.ADLibrary;
...
import com.blankj.utilcode.customwidget.ADLibrary.bean.AdInfo;
...
public class AdManager {
    ...
    public AdManager(WeakReference<Activity> weakReference, List<AdInfo> advInfoListList, CustomExceptionCallBack customExceptionCallBack) {
        if (EmptyUtils.isEmpty(weakReference)||EmptyUtils.isEmpty(weakReference.get())){
            if (customExceptionCallBack!=null){
                customExceptionCallBack.onEmptyException("AdManager,context is null");
            }
        }else {

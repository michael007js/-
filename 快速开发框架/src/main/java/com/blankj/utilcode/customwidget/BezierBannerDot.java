...
xml中(替换成自己的路径)：
       ...
       <com.blankj.utilcode.customwidget.BezierBannerDot
        android:id="@+id/bd"
...
public class BezierBannerDot extends View implements ViewPager.OnPageChangeListener {
    ...
    private void initattrs(Context context) {
        mSelectedColor = context.getResources().getColor(R.color.mainColor);
        mUnSelectedColor = context.getResources().getColor(R.color.text_grey);
    }

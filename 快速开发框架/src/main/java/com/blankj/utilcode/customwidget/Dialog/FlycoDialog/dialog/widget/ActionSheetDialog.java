...
import com.blankj.utilcode.customwidget.Dialog.FlycoDialog.dialog.widget.base.BottomBaseDialog;
...
public class ActionSheetDialog extends BottomBaseDialog<ActionSheetDialog> {
    ...
    public void setUiBeforShow() {
        ...
        mTvCancel.setBackgroundDrawable(CornerUtils.listItemSelector(radius, mCancelBgColor, mItemPressColor, 1, 0));

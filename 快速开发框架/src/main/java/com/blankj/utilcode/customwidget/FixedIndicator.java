 ...
 *
 ...
 step1:
 <com.blankj.utilcode.customwidget.FixedIndicator
 xmlns:app="http://schemas.android.com/apk/res-auto"
 android:id="@+id/indicator_main_view"
 android:layout_width="300dp"
 android:layout_height="40dp"
 android:background="#00000000"
 app:indicator_dividerColor="#aaaaaa"
 app:indicator_dividerVerticalMargin="5dp"
 app:indicator_dividerWidth="2dp"
 app:indicator_hasDivider="true"
 app:indicator_textColor="#aa000000"
 app:indicator_textSizeNormal="14sp"
 app:indicator_textSizeSelected="16sp"
 app:indicator_triangleColor="#ff0000"
 ...
 step3:
 FragmentAdapter adapter = new FragmentAdapter(getSupportFragmentManager(),title);
 ...
 step6:
 indicator_main_view.initData(0,viewpager);
 *
 *
 */
public class FixedIndicator extends LinearLayout implements View.OnClickListener, View.OnFocusChangeListener {
    private static final String TAG = FixedIndicator.class.getSimpleName();
    ...
    private OnClickTabCallBack mOnClickTabCallBack;

    public void setOnClickTabCallBack(OnClickTabCallBack onClickTabCallBack) {
        this.mOnClickTabCallBack = onClickTabCallBack;
    }

    public FixedIndicator(Context context) {
        this(context, null);
    }

    public FixedIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void onClick(View v) {
        ...
        if (mOnClickTabCallBack!=null){
            mOnClickTabCallBack.onClickTab(mCurrentTabIndex);
        }
    }

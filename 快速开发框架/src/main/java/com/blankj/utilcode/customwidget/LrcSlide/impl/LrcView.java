package com.blankj.utilcode.customwidget.LrcSlide.impl;
...
import com.blankj.utilcode.customwidget.LrcSlide.ILrcDownLoad;
import com.blankj.utilcode.customwidget.LrcSlide.ILrcView;
import com.blankj.utilcode.customwidget.LrcSlide.ILrcViewListener;
...
public class LrcView extends View implements ILrcView {
     ...
     * 当前高亮歌词的字体颜色
     */
    private int mHignlightRowColor = Color.parseColor("#4bacff");
    /**
     * 不高亮歌词的字体颜色为白色
     */
     ...
     **/
    private int mMaxSeekLineTextSize = 21;
     ...
     * 当没有歌词的时候点击开始下载歌词
     */
    private ILrcDownLoad mLrcDownLoad;
    /**
     * 当没有歌词的时候展示的内容
     **/
    private String mLoadingLrcTip = "无歌词,点击下载";
    ...
    public void setLrcDownLoadListener(ILrcDownLoad mLrcDownLoad) {
        this.mLrcDownLoad = mLrcDownLoad;
    }
...
//        if (mLrcRows == null || mLrcRows.size() == 0) {
//            mLrcDownLoad.startDownLoadLrc( songName, singerName);
...
//        }
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                if (event.getX() - x >0&&event.getX() - x < 15) {
                    mLrcDownLoad.startDownLoadLrc(songName, singerName);
                }
                if (mLrcRows != null) {
                    if (mLrcRows.size() > 0) {

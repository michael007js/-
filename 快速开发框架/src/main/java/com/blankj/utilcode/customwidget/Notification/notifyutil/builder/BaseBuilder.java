...
public class BaseBuilder {
   ...
   public boolean lights = true;
    ...
    public void build(){
        cBuilder = new NotificationCompat.Builder(NotifyUtil.getContext());
        ...
        if(bigIcon >0){
            cBuilder.setLargeIcon(BitmapFactory.decodeResource(NotifyUtil.getContext().getResources(), bigIcon));
        }

...
public class MediaBuilder extends BaseBuilder{
    ...
    public void build() {
        ...
        style.setMediaSession(new MediaSessionCompat(NotifyUtil.getContext(),"MediaSession",
                new ComponentName(NotifyUtil.getContext(), Intent.ACTION_MEDIA_BUTTON),null).getSessionToken());
        //设置要现实在通知右方的图标 最多三个

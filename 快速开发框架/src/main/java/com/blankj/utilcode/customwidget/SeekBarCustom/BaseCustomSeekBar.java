...
import static com.blankj.utilcode.customwidget.SeekBarCustom.CustomSeekBarUtils.dp2px;
import static com.blankj.utilcode.customwidget.SeekBarCustom.CustomSeekBarUtils.sp2px;
...
public abstract class BaseCustomSeekBar extends View {
    ...
    private void initViewDate(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (style == 1) {
            mTextStyle = TextStyle.TOP_TEXT;
        } else {
            mTextStyle = TextStyle.BOTTOM_TEXT;
        }

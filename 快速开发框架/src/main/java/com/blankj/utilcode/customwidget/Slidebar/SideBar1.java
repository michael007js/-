...
public class SideBar1 extends View {
    ...
    private static final String TAG = SideBar1.class.getSimpleName();
    ...
    public SideBar1(Context context, AttributeSet attrs, int defStyleAttr) {
                ...
                if (mIsBeingDragged) {
                    ...
                    if (mChoose != characterIndex) {
                        if (characterIndex >= 0 && characterIndex < mLetters.length) {
                            ...
                            mOnTouchingLetterChangedListener.onTouchingLetterChanging(mLetters[characterIndex]);
                        }
                    }
                    invalidate();
                }

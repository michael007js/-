...
public class CustomCacheViewPager extends ViewGroup {
    ...
    private static final int DEFAULT_OFFSCREEN_PAGES = 5;// 默认的加载页面,ViewPager是1个,所以会加载两个Fragment
    ...
    public CustomCacheViewPager(Context context) {
        super(context);
        initViewPager();
    }

    public CustomCacheViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }

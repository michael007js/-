...
import com.blankj.utilcode.customwidget.banner.listener.OnBannerClickListener;
...
import com.blankj.utilcode.customwidget.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        bannerBackgroundImage = typedArray.getResourceId(R.styleable.Banner_banner_default_image, R.mipmap.logo_default);
        typedArray.recycle();
    }

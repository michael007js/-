package com.blankj.utilcode.customwidget.bilibili_search_box.db;
...
public class SearchHistoryDB extends SQLiteOpenHelper {
    ...
    public static String DB_NAME = "SearchHistory_db";
    ...
    public SearchHistoryDB(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
        ...
        if (EmptyUtils.isNotEmpty(AppUtils.getAppName(weakReference,null))){
            DB_NAME=AppUtils.getAppName(weakReference,null);
        }

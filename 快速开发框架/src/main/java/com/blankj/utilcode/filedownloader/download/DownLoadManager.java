...
package com.blankj.utilcode.filedownloader.download;

import android.content.Context;
import android.content.SharedPreferences;


import com.blankj.utilcode.filedownloader.download.dbcontrol.DataKeeper;
import com.blankj.utilcode.filedownloader.download.dbcontrol.FileHelper;
import com.blankj.utilcode.filedownloader.download.dbcontrol.bean.SQLDownLoadInfo;
...
public class DownLoadManager {
    ...
    private void init(Context context) {
        ...
        userID = sharedPreferences.getString("UserID","SSS");

...
public class FrescoImagePipelineConfig {
     ...
     * @param context
     * @param config  若不是要求忒高清显示应用，就用使用RGB_565吧（默认是ARGB_8888)
     * @return
     */
    public static ImagePipelineConfig getImagePipelineConfig(final Context context,Bitmap.Config config) {
...
//            }
            ...
            memoryTrimmableRegistry.registerMemoryTrimmable(new MemoryTrimmable() {
                ...
                public void trim(MemoryTrimType trimType) {
                    ...
                    Log.e("sssss",String.format("Fresco onCreate suggestedTrimRatio : %d", suggestedTrimRatio));
...
//            sImagePipelineConfig = ImagePipelineConfig.newBuilder(context)
                    .setBitmapsConfig(config) // 若不是要求忒高清显示应用，就用使用RGB_565吧（默认是ARGB_8888)

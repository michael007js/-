...
public class AnimationUtils {
     ...
     * 获取一个位移动画
     *
     * @param fromXDelta 起始点X轴坐标（数值、百分数、百分数p，
     *                   譬如50表示以当前View左上角坐标加50px为初始点、
     *                   50%表示以当前View的左上角加上当前View宽高的50%做为初始点、
     *                   50%p表示以当前View的左上角加上父控件宽高的50%做为初始点）
     * @param toXDelta   结束点X轴坐标，同上规律
     * @param fromYDelta 起始点Y轴从标，同上规律
     * @param toYDelta   结束点Y轴坐标，同上规律
     * @return
     */
     ...
     * 获取一个位移动画
     *
     * @param fromXType  Animation.RELATIVE_TO_PARENT或Animation.RELATIVE_TO_SELF
     * @param fromXValue 从X点开始
     * @param toXType    Animation.RELATIVE_TO_PARENT或Animation.RELATIVE_TO_SELF
     * @param toXValue   到X点结束
     * @param fromYType  Animation.RELATIVE_TO_PARENT或Animation.RELATIVE_TO_SELF
     * @param fromYValue 从Y点开始
     * @param toYType    Animation.RELATIVE_TO_PARENT或Animation.RELATIVE_TO_SELF
     * @param toYValue   到Y点结束
     * @return
     */

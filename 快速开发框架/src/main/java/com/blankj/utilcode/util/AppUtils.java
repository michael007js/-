...
public final class AppUtils {
     ...
     * 获取App名称
     *
     * @param weakReference   上下文
     * @param customExceptionCallBack
     * @return App名称
     */
    public static String getAppName(WeakReference<Context> weakReference, CustomExceptionCallBack customExceptionCallBack) {
        if (weakReference==null||weakReference.get()==null){
            if (customExceptionCallBack!=null){
                customExceptionCallBack.onEmptyException("getAppName,context is null");
            }
            return null;
        }
        return getAppName(weakReference.get(), weakReference.get().getPackageName(),customExceptionCallBack);
    }
     ...
     * @return App名称
     */
    public static String getAppName(Context context, CustomExceptionCallBack customExceptionCallBack) {
        if (context==null){
            if (customExceptionCallBack!=null){
                customExceptionCallBack.onEmptyException("getAppName,context is null");
            }
        ...
        return getAppName(context, context.getPackageName(),customExceptionCallBack);
    }
     ...
     * @return App名称
     */
    public static String getAppName(Context context, String packageName, CustomExceptionCallBack customExceptionCallBack) {
        if (isSpace(packageName)) {
            if (customExceptionCallBack!=null){
                customExceptionCallBack.onEmptyException("getAppName,package name is null");
            }
            return null;
        }
        try {
     ...
     *
     * @param weakReference 上下文
     * @param customExceptionCallBack 错误回调
     * @return App图标
     */
    public static Drawable getAppIcon(WeakReference<Context> weakReference, CustomExceptionCallBack customExceptionCallBack) {
        if (weakReference==null||weakReference.get()==null){
            if (customExceptionCallBack!=null){
                customExceptionCallBack.onEmptyException("getAppIcon,context is null");
            }
            return null;
        }
        return getAppIcon(weakReference.get(), weakReference.get().getPackageName());
    }
    ...
    public static boolean isBackground(Context context) {
        ...
        for (ActivityManager.RunningAppProcessInfo appProcess : appProcesses) {
            if (appProcess.processName.equals(context.getPackageName())) {
				 ...
				 */
                LogUtils.e(context.getPackageName(), "此appimportace ="
                        + appProcess.importance
                        + ",context.getClass().getName()="
                        + context.getClass().getName());
                if (appProcess.importance != ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
                    LogUtils.e(context.getPackageName(), "处于后台"
                            + appProcess.processName);
                    return true;
                } else {
                    LogUtils.e(context.getPackageName(), "处于前台"
                            + appProcess.processName);
                    return false;
                }
            }

...
public final class CrashUtils {
    ...
    static {
        try {
            PackageInfo pi = UtilCodeApplication.getContext()
                    .getPackageManager()
                    .getPackageInfo(UtilCodeApplication.getContext().getPackageName(), 0);
            if (pi != null) {
    ...
    public static void init(final String crashDir, final OnCrashListener onCrashListener) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                && UtilCodeApplication.getContext().getExternalCacheDir() != null)
            defaultDir = UtilCodeApplication.getContext().getExternalCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        else {
            defaultDir = UtilCodeApplication.getContext().getCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        }

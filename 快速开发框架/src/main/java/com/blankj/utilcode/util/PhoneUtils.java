...
import static com.blankj.utilcode.R.id.listview;
...
public final class PhoneUtils {
    ...
    public static List<ContactVo> getPhoneContacts(Context context) {
         List<ContactVo>lists=new ArrayList<ContactVo>();
...
//                    continue;
                ...
                if (imgid > 0) {
                    ...
                    cv.setImg(BitmapFactory.decodeStream(input));
                } else {
                    cv.setImg(BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_launcher));
                }

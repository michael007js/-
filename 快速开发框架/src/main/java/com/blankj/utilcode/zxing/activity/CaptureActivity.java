 ...
 */
package com.blankj.utilcode.zxing.activity;
...
import com.blankj.utilcode.zxing.camera.CameraManager;
import com.blankj.utilcode.zxing.decode.DecodeThread;
import com.blankj.utilcode.zxing.utils.BeepManager;
import com.blankj.utilcode.zxing.utils.CaptureActivityHandler;
import com.blankj.utilcode.zxing.utils.InactivityTimer;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    private ImageView scanLine, flashLight;
    ...
    public void onCreate(Bundle icicle) {
        ...
        flashLight.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isOn){
                    flashText.setText("关闭闪光灯");
                }else {
                    flashText.setText("开启闪光灯");
                }
            }
        });
    }
...
//		startActivity(new Intent(CaptureActivity.this, ResultActivity.class).putExtras(bundle));
        mSSS_QRCodeDataListener.onQRCodeDataChange(rawResult.getText(),getBaseContext());
